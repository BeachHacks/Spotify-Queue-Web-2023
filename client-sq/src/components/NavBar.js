            ...
            <div style={{
                ...
                <div style={{ alignItems: "center", alignSelf: "center", alignContent: "center", marginLeft: '1vw', marginTop: '2vh' }}>
                    <div style={{
                        ...
                        <div style= {{marginLeft:'-1.5vw', marginTop: '1.55vw'}}>
                            <img class = "floating" style={{transition:'transform .2s', width: 5 * .15 + 'vw', height: 5 * 0.19 + 'vw' }}
                            src="note2.png" />
                            <img class = "floating" style={{animationDelay: '.25s', marginTop:'1.2vw',marginLeft:'-.4vw',transition:'transform .2s', width: 5 * .22 + 'vw', height: 5 * 0.21 + 'vw' }}
                            src="note1.png" />
                        </div>
