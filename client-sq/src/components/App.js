          ...
          <NavBar theme={theme} mode={mode}>
            <div  style={{position: "absolute", bottom: '4.5vh' , left: '2.645vw'  }}>
              <div style = {{}}>
                ...
                <div style={{marginBottom: '1.5vh',display: "table", height: '5vh', overflow: "hidden"}}>
                  <div style={{fontSize: '1.85vh', fontWeight: 500, width: '23.5vh', borderRadius: '.75vh', backgroundColor:theme.palette.common.border,textAlign: 'center',display: "table-cell", verticalAlign: "middle"}}>
