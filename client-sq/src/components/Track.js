    ...
    <>
      <TableRow
        ...
        {clickable == false ? <Fade in={true} timeout={500}>
          <TableCell style={{
            width: '2.15vw', padding: "2.08vh .55vw", fontSize: window.innerHeight * 0.018, fontWeight: 500, fontFamily: "DM Sans", color: "#6d7285",
        ...
        <div style={{ marginLeft: -window.innerWidth * 0.007, alignItems: "center", align: "center" }}>
          ...
          {clickable == false ? <Fade in={true} timeout={1000}><TableCell style={{ padding: "1.3vh .8vw", width: window.innerWidth * 0.3, fontFamily: "DM Sans", color: theme.palette.text.primary }} align="left">
