...
function NowPlaying() {
  ...
  const millisecondsToMinute = (millisec) => {
    ...
    return (
      <Zoom direction = 'left' key={playbackState.title} in={true} timeout={500} >
    ...
    <Slide direction = 'left' key={playbackState.title} in={true} timeout={500}>
                ...
                <Slide direction = 'left' key={playbackState.artist} in={true} timeout={600}>
              ...
              <Slide direction = 'left' key={playbackState.duration} in={true} timeout={700}>
